...
DROP POLICY IF EXISTS "Public read count" ON active_checkins;
...
DROP POLICY IF EXISTS "Authenticated insert" ON active_checkins;
...
DROP POLICY IF EXISTS "Authenticated delete" ON active_checkins;
